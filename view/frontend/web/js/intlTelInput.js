...
(function(factory) {
   ...
   ********************/
            ...
            if ($.fn[pluginName].autoCountry) {
                ...
                if (typeof this.options.geoIpLookup === "function") {
                    this.options.geoIpLookup(function(countryCode) {
                        $.fn[pluginName].autoCountry = countryCode;
        ...
        _setFlag: function(countryCode) {
            ...
            // update the country in select options in field country
            var country = countryCode ? this.selectedCountryData.name + "" : "Unknown";
